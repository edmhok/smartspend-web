        ...
        <div className="flex flex-row md:flex-col flex-wrap md:flex-nowrap items-center md:items-start mt-8 relative">
          ...
          <div className="flex items-start rounded-lg md:w-auto">
            <div className="flex flex-col items-center md:w-auto">
              <div className="flex flex-grow md:ltr:mr-3 w-[450px] h-[330px]">
                <Image
                  src={detail.photo || ''}
                  alt="product img"
                  width={450}
          ...
          {/* Detail Section */}
          <div className="bg-palette-card md:bg-transparent w-[100vw] md:w-auto px-5 flex-grow justify-start lg:self-start mt-8 md:mt-0 !-mx-[1rem] lg:ltr:ml-4 py-5 md:py-0 rounded-tl-[4rem] rounded-tr-[3rem] flex flex-col z-10">
            <h2 className="text-palette-mute whitespace-normal text-xl text-center ltr:md:text-left">
              {detail.productName}
            </h2>
            <hr className="mt-1 md:block" />
            <h5 className="text-palette-mute flex justify-center marker:text-sm py-1 my-1">{detail.description}</h5>
                ...
                <div className="mt-4">
                  ...
                  <div className="flex flex-wrap items-center">
                    ...
                    <ul className="ps-1">
                      ...
                      <li className='text-palette-mute text-sm py-1 my-1'>Color: <strong>{detail.color}</strong></li>
                      <li className='text-palette-mute text-sm py-1 my-1'>Tags: <strong>{detail.tags}</strong></li>
                      <li className='text-palette-mute text-sm py-1 my-1'>Variant: <strong>{detail.variant}</strong></li>
                    </ul>
                  </div>
