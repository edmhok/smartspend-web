    ...
    <div className=" w-full flex flex-col items-center">
        ...
        <Grid container spacing={2}>
            ...
            <FormControl className='ps-[200px]'>
                <div className='text-fuchsia-600 font-semibold text-xl pb-5'>Shipping Method</div>
                <Box sx={{ width: '100%' }}>
                <RadioGroup 
                    name="delivery"
                ...
                <div className='w-[300px] flex flex-col ps-10 pt-10'>
                    ...
                    <ul className='flex flex-row'>
                        <li className='w-[460px] h-[70px] flex flex-row space-x-2'>
                            <div className='w-[60px] h-[70px] bg-fuchsia-500 '></div>
                            <div className='ps-1'>
